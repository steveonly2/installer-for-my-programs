...
REPACKER_URL = 'https://github.com/suiyang12/Workout-Helper-V1.0/raw/main/repacker.py'
ROGUI_URL = 'https://github.com/suiyang12/Workout-Helper-V1.0/raw/main/roguiv2.0.py'
...
def create_gui():
    ...
    # Create a button to download Repacker
    ...
    # Add a question mark icon next to Repacker button using text
    ...
    # Create a button to download RoGui
    download_ro_gui_button = tk.Button(root, text="Download RoGui.py", font=("Arial", 14),
                                       command=lambda: on_download_click(ROGUI_URL, 'roguiv2.0.py'))
    download_ro_gui_button.pack(pady=10, side=tk.LEFT, padx=20)

    # Add a question mark icon next to RoGui button using text
    ro_gui_info_button = tk.Button(root, text="❓", font=("Arial", 14), command=lambda: show_info(
        "RoGui.py: Contains an autoclicker and an AFK mode for Roblox. Useful for automating tasks in Roblox."))
